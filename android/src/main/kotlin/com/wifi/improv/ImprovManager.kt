...
class ImprovManager(
    ...
    private val rpcResultParser = RpcResultParser()
        ...
        override fun onCharacteristicChanged(
            ...
            when (characteristic.uuid) {
                ...
                UUID_CHAR_RPC_RESULT -> {
                    ...
                    val results = extractResultStrings(characteristic.value)
                    if (results.isNotEmpty()) {
                        results.forEach(callback::onRpcResult)
                    } else {
    ...
    private fun extractResultStrings(data: ByteArray): List<List<String>> {
        return rpcResultParser.append(data)
    }
